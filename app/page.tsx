        ...
        <div className="container mx-auto px-4 flex justify-evenly">
          {Logo && (
            <Image
              ...
              width={200}
              height={200}
              className="hidden xl:block h-20 object-contain"
              sizes="100vw"
              quality={100}
            />
          )}
      ...
      <main className="flex-1 container justify-center gap-5 mx-auto px-4 py-12 flex flex-col xl:flex-row relative">
        ...
        {currentTitle && (
          <>
            <button
              type="button"
              className="fixed bottom-6 right-6 z-50 xl:hidden flex items-center justify-center w-14 h-14 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 transition-all"
            ...
            {showMobileReq && (
              ...
              >
                <div
                  className="w-full bg-white rounded-t-2xl shadow-xl p-5 max-h-[60vh] overflow-y-auto"
        ...
        {currentTitle && (
          <div className="w-full max-w-md flex flex-col items-start gap-4 hidden xl:flex">
